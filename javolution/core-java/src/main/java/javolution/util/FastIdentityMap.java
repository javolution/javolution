 ...
 */
@Realtime
@DefaultTextFormat(FastIdentityMap.Text.class)
public class FastIdentityMap<K, V> implements Map<K, V>, ConcurrentMap<K, V>,
        Serializable {
     ...
     */
    public static <K,V> FastIdentityMap<K,V> of(Map<? extends K, ? extends V> that) {
    	FastIdentityMap<K,V> map = new FastIdentityMap<K,V>();
    	map.putAll(that);
        return map;
    }
    ...
    public FastIdentityMap() {
        service = new FastIdentityMapImpl<K, V>();
    }
     ...
     */
    protected FastIdentityMap(MapService<K, V> service) {
    ...
    public FastIdentityMap<K, V> atomic() {
        return new FastIdentityMap<K, V>(new AtomicMapImpl<K, V>(service));
    }
    ...
    public FastIdentityMap<K, V> shared() {
        return new FastIdentityMap<K, V>(new SharedMapImpl<K, V>(service));
    }
     ...
     */
    public FastIdentityMap<K, V> parallel() {
        return new FastIdentityMap<K, V>(new ParallelMapImpl<K, V>(service));
    }
     ...
     */
    public FastIdentityMap<K, V> sequential() {
        return new FastIdentityMap<K, V>(new SequentialMapImpl<K, V>(service));
    }
     ...
     */
    public FastIdentityMap<K, V> unmodifiable() {
        return new FastIdentityMap<K, V>(new UnmodifiableMapImpl<K, V>(service));
    }
     ...
     */
    public FastIdentityMap<K, V> add(K key, V value) {
    	put(key, value);
        return this;
    }
    ...
    public String toString() {
        return TextContext.getFormat(FastIdentityMap.class).format(this);
    }
     ...
     */
    @Parallelizable
    public static class Text extends TextFormat<FastIdentityMap<?, ?>> {

        @Override
        public FastIdentityMap<Object, Object> parse(CharSequence csq, Cursor cursor)
                throws IllegalArgumentException {
            throw new UnsupportedOperationException();
        }

        @Override
        public Appendable format(FastIdentityMap<?, ?> that, final Appendable dest)
                throws IOException {
