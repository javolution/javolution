 ...
 */
package javolution.osgi.internal.runtime;
...
/**
 *  OSGi lightweight framework implementation.
 */
public class OSGiImpl extends OSGi {
    ...
    void fireServiceEvent(ServiceEvent serviceEvent) {
        ServiceReferenceImpl<?> serviceReference = (ServiceReferenceImpl<?>) serviceEvent
                .getServiceReference();
