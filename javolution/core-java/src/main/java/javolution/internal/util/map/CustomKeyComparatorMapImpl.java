 ...
 */
public final class CustomKeyComparatorMapImpl<K, V> implements MapService<K, V>, Serializable {

    private final MapService<K,V> that;

    public CustomKeyComparatorMapImpl(MapService<K,V> that, EqualityComparator<K> cmp) {
        this.that = that;
    }
