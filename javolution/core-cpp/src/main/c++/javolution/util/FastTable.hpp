...
namespace javolution {
    namespace util {
        ...
        public:
            ...
            FastTable(Type::NullHandle = Type::Null) : Type::Handle<FastTable_API<E> >() {
            } // Null
...
public:
     ...
     */
    virtual Type::boolean addAll(Type::int32 index, Collection<E> const& c) {
        if ((index < 0) || (index > count))
            throwIndexOutOfBoundsException(index);
     ...
     */
    virtual Type::int32 indexOf(javolution::lang::Object const& o) const {
        if (o == Type::Null) {
     ...
     * or <code>-1</code> if this list does not contain this element.
     */
    virtual Type::int32 lastIndexOf(javolution::lang::Object const& o) const {
        if (o == Type::Null) {
...
public:
    ...
    Type::int32 indexOf(javolution::lang::Object const& o) const {
        if (o == Type::Null) {
            for (Type::int32 i = 0; i < count; i++) {
                if (get(i) == Type::Null)
                    return i;
    ...
    Type::int32 lastIndexOf(javolution::lang::Object const& o) const {
        if (o == Type::Null) {
            for (Type::int32 i = count - 1; i >= 0; i--) {
                if (get(i) == Type::Null)
                    return i;
    ...
    Type::boolean addAll(Type::int32, Collection<E> const&) {
        throwUnsupportedOperationException();
        return false;
    }
