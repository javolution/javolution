...
import org.javolution.context.Context;
...
public abstract class TestContext extends LogContext {
    ...
    protected boolean doAssert(boolean value, CharSequence message) {
        ...
        org.javolution.text.TextBuilder tmp = org.javolution.text.TextBuilder.newInstance();
        try {
            tmp.append(message);
            ...
            org.javolution.text.TextBuilder.recycle(tmp);
        }
        /**/
        return false;
    }
