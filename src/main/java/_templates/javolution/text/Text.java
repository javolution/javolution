...
public final class Text implements CharSequence, Comparable, XMLSerializable,
     ...
     */
    public Text replace(_templates.java.lang.CharSequence target, _templates.java.lang.CharSequence replacement) {
     ...
     * @return the resulting text.
     */
    public Text replace(CharSet charSet, _templates.java.lang.CharSequence replacement) {
     ...
     *         (start > end) || (end > this.length())</code>
     */
    public _templates.java.lang.CharSequence subSequence(int start, int end) {
     ...
     */
    public int indexOf(_templates.java.lang.CharSequence csq) {
     ...
     *         or <code>-1</code> if the character sequence is not found.
     */
    public int indexOf(_templates.java.lang.CharSequence csq, int fromIndex) {
     ...
     *         or <code>-1</code> if the character sequence is not found.
     */
    public int lastIndexOf(_templates.java.lang.CharSequence csq) {
     ...
     */
    public int lastIndexOf(_templates.java.lang.CharSequence csq, int fromIndex) {
     ...
     */
    public boolean startsWith(_templates.java.lang.CharSequence prefix) {
     ...
     *         this text; <code>false</code> otherwise.
     */
    public boolean endsWith(_templates.java.lang.CharSequence suffix) {
     ...
     */
    public boolean startsWith(_templates.java.lang.CharSequence prefix, int index) {
     ...
     */
    public static Text intern(final _templates.java.lang.CharSequence csq) {
     ...
     */
    public boolean contentEquals(_templates.java.lang.CharSequence csq) {
     ...
     */
    public boolean contentEqualsIgnoreCase(_templates.java.lang.CharSequence csq) {
